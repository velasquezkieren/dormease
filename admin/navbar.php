...
if (isset($_SESSION['a_ID'])) {
    ...
    $a_Contact = $_SESSION['a_ContactNumber'];
}
...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
        <a class="navbar-brand me-auto" href="<?php echo isset($_SESSION['a_ID']) ? 'dashboard' : 'login'; ?>">
            <img src="../assets/logo_img/logo-c.svg" height="50" width="auto">
        </a>
        <?php if (isset($_SESSION['a_ID'])): ?>
            <div class="dropdown">
                <button class="btn login-button dropdown-toggle" type="button" id="usernameDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <?php echo htmlspecialchars($a_Username); ?>
                </button>
