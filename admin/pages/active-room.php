                    ...
                    <?php if ($activeRoomResult->num_rows > 0): ?>
                        <?php while ($row = $activeRoomResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit-room?r_ID=<?php echo urlencode($row['r_ID']); ?>" class="btn btn-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                            <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                        </svg>
                                        Edit Room
                                    </a>
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteRoomModal<?php echo $row['r_ID']; ?>">
                                    ...
                                    <!-- Delete Room Modal -->
                                    <div class="modal" id="deleteRoomModal<?php echo $row['r_ID']; ?>" tabindex="-1" aria-labelledby="deleteRoomModalLabel<?php echo $row['r_ID']; ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteRoomModalLabel<?php echo $row['r_ID']; ?>">Delete Room: <?php echo htmlspecialchars($row['r_Name']); ?></h5>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="delete-room">
                                                        <input type="hidden" name="r_ID" value="<?php echo htmlspecialchars($row['r_ID']); ?>">
