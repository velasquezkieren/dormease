                    ...
                    <?php if ($tenantsResult->num_rows > 0): ?>
                        <?php while ($row = $tenantsResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#editListingModal<?= $dorm['d_ID']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
