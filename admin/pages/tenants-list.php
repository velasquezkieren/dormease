...
$tenantsQuery = "SELECT u_ID, u_FName, u_MName, u_LName, u_ContactNumber, u_Email, u_Balance, u_BalanceStatus FROM user WHERE u_Account_Type = 1";
                    ...
                    <?php if ($tenantsResult->num_rows > 0): ?>
                        <?php while ($row = $tenantsResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-dark" href="edit-user?u_ID=<?= $tenantsQuery = htmlspecialchars($row['u_ID']); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="delete-user?u_ID=<?= $tenantsQuery = htmlspecialchars($row['u_ID']); ?>" method="POST">
