...
<div class="container pt-5 mt-5 min-vh-100">
    <div class="row mt-5 pt-3">
        <div class="col-md-8 offset-md-2">
            <h2 class="text-center mb-4">Adding Room for <?php echo htmlspecialchars($dormName); ?></h2>
            <form action="" method="POST" class="bg-light p-4 border rounded shadow">
                <div class="form-group">
                    <label for="r_Name">Room Name</label>
                    <input type="text" name="r_Name" class="form-control" required placeholder="Enter room name">
                </div>
                <div class="form-group">
                    <label for="r_Description">Description</label>
                    <textarea name="r_Description" class="form-control" required placeholder="Enter room description"></textarea>
                </div>
                <div class="form-group form-check">
                    <input type="checkbox" name="r_Availability" value="1" class="form-check-input" id="r_Availability">
                    <label class="form-check-label" for="r_Availability">Available</label>
                </div>
                <div class="form-group">
                    <label for="r_Capacity">Capacity</label>
                    <input type="number" name="r_Capacity" class="form-control" required placeholder="Enter room capacity" min="1">
                </div>
                <div class="d-flex justify-content-between mt-4">
                    <button type="submit" class="btn btn-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-add-fill me-2" viewBox="0 0 16 16">
